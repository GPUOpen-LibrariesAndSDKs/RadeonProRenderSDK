...
NB_MODULE(rpr, m) {
	...
	m.attr("VERSION_REVISION") = 7 ;
	m.attr("VERSION_BUILD") = 0x690fa900 ;
	m.attr("VERSION_MAJOR_MINOR_REVISION") = 0x00300107 ;
	...
	nb::enum_<ContextInfo>(m, "ContextInfo")
		...
		.value("REFLECTION_ENERGY_COMPENSATION_ENABLED", ContextInfo::REFLECTION_ENERGY_COMPENSATION_ENABLED)
		.value("NORMALIZE_LIGHT_INTENSITY_ENABLED", ContextInfo::NORMALIZE_LIGHT_INTENSITY_ENABLED)
