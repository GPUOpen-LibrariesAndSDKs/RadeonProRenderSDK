...
//Have a look at the Camera Setup Part line 151
int main()
{
...
// 1) Try to create an animation by moving the camera arround
// 2) Try to modify camera mode to RPR_CAMERA_MODE_ORTHOGRAPHIC or RPR_CAMERA_MODE_FISHEYE with rprCameraSetMode and rprCameraSetOrthoWidth/Height
// 3) Try to modify other properties have a look in RadeonProRender.h -> rprCameraSetLensShift, rprCameraSetTiltCorrection, ...