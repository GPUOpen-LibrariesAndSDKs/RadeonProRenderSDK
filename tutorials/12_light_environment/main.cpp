...
// 1) As you can see the hdr is low res to avoid huge repository, you could try to change the hdr by your own
// 2) You could try to change the intensity rprEnvironmentLightSetIntensityScale