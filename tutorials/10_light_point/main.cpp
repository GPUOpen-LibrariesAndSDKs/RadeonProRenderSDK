...
// 1) You can modify the Radian Power, and change the color
// 2) You can try to create a different kind of light have a look at rprContextCreateDirectionalLight, rprContextCreateSpotLight
// 3) Maybe you could setup a recursive rendering by moving the camera, like a two miror reflection