...
int main()
{
	...
	rpr_material_node material = nullptr;
	{
		...
		CHECK(rprShapeSetMaterial(cube, material));
		CHECK(rprMaterialNodeSetInputFByKey(material, RPR_MATERIAL_INPUT_UBER_BACKSCATTER_WEIGHT, 1.f, 1.f, 1.f, 0.f));
		CHECK(rprMaterialNodeSetInputFByKey(material, RPR_MATERIAL_INPUT_UBER_BACKSCATTER_COLOR, 1.f, 1.f, 1.f, 1.f));
		CHECK(rprMaterialNodeSetInputFByKey(material, RPR_MATERIAL_INPUT_UBER_REFLECTION_WEIGHT, 1.f, 1.f, 1.f, 1.f));
		CHECK(rprMaterialNodeSetInputFByKey(material, RPR_MATERIAL_INPUT_UBER_REFLECTION_COLOR, 1.f, 1.f, 1.f, 1.f));
		CHECK(rprMaterialNodeSetInputFByKey(material, RPR_MATERIAL_INPUT_UBER_REFLECTION_ROUGHNESS, 0.f, 0.f, 0.f, 0.f));
		CHECK(rprMaterialNodeSetInputFByKey(material, RPR_MATERIAL_INPUT_UBER_SSS_WEIGHT, 1.f, 1.f, 1.f, 1.f));
		CHECK(rprMaterialNodeSetInputFByKey(material, RPR_MATERIAL_INPUT_UBER_SSS_SCATTER_COLOR, 0.9f, 0.5f, 0.1f, 0.f));
		CHECK(rprMaterialNodeSetInputFByKey(material, RPR_MATERIAL_INPUT_UBER_SSS_SCATTER_DISTANCE, 0.1f, 0.1f, 0.1f, 1.f));
		CHECK(rprMaterialNodeSetInputFByKey(material, RPR_MATERIAL_INPUT_UBER_SSS_SCATTER_DIRECTION, 0.f, 0.f, 0.f, 0.f));
		CHECK(rprMaterialNodeSetInputUByKey(material, RPR_MATERIAL_INPUT_UBER_SSS_MULTISCATTER, RPR_TRUE));
	}

	rpr_material_node material1 = nullptr;
	{
		CHECK(rprMaterialSystemCreateNode(matsys,RPR_MATERIAL_NODE_UBERV2,&material1));
		CHECK(rprShapeSetMaterial(instance, material1));
		CHECK(rprMaterialNodeSetInputFByKey(material1, RPR_MATERIAL_INPUT_UBER_BACKSCATTER_WEIGHT, 1.f, 1.f, 1.f, 0.f));
		CHECK(rprMaterialNodeSetInputFByKey(material1, RPR_MATERIAL_INPUT_UBER_BACKSCATTER_COLOR, 1.f, 1.f, 1.f, 1.f));
		CHECK(rprMaterialNodeSetInputFByKey(material1, RPR_MATERIAL_INPUT_UBER_REFLECTION_WEIGHT, 1.f, 1.f, 1.f, 1.f));
		CHECK(rprMaterialNodeSetInputFByKey(material1, RPR_MATERIAL_INPUT_UBER_REFLECTION_COLOR, 1.f, 1.f, 1.f, 1.f));
		CHECK(rprMaterialNodeSetInputFByKey(material1, RPR_MATERIAL_INPUT_UBER_REFLECTION_ROUGHNESS, 0.f, 0.f, 0.f, 0.f));
		CHECK(rprMaterialNodeSetInputFByKey(material1, RPR_MATERIAL_INPUT_UBER_SSS_WEIGHT, 1.f, 1.f, 1.f, 1.f));
		CHECK(rprMaterialNodeSetInputFByKey(material1, RPR_MATERIAL_INPUT_UBER_SSS_SCATTER_COLOR, 0.9f, 0.5f, 0.1f, 0.f));
		CHECK(rprMaterialNodeSetInputFByKey(material1, RPR_MATERIAL_INPUT_UBER_SSS_SCATTER_DISTANCE, 1.1f, 1.1f, 1.1f, 1.f));
		CHECK(rprMaterialNodeSetInputFByKey(material1, RPR_MATERIAL_INPUT_UBER_SSS_SCATTER_DIRECTION, 0.f, 0.f, 0.f, 0.f));
		CHECK(rprMaterialNodeSetInputUByKey(material1, RPR_MATERIAL_INPUT_UBER_SSS_MULTISCATTER, RPR_TRUE));
	...
	CHECK(rprObjectDelete(material1));material1=nullptr;
