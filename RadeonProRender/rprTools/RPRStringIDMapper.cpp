...
RPRStringIDMapper::RPRStringIDMapper()
{
	...
	MACRO_LINK_STR_ID("matx_diffuseBrdf",RPR_MATERIAL_NODE_MATX_DIFFUSE_BRDF); //0x2f
	MACRO_LINK_STR_ID("matx_dielectricBrdf",RPR_MATERIAL_NODE_MATX_DIELECTRIC_BRDF); //0x30
	MACRO_LINK_STR_ID("matx_generalizedSchlickBrdf",RPR_MATERIAL_NODE_MATX_GENERALIZED_SCHLICK_BRDF); //0x31
	#undef MACRO_LINK_STR_ID
